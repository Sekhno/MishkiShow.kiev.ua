...
window.addEventListener("load", () => {
    ...
    const fs = `
        ...
        void main() {
            ...
            vec2 firstDisplacementCoords = vec2(vFirstTextureCoord.x, vFirstTextureCoord.y - (1.0 - displacementFactor) * (displacementTexture.r * effectFactor));
            vec2 secondDisplacementCoords = vec2(vSecondTextureCoord.x, vSecondTextureCoord.y + displacementFactor * (displacementTexture.r * effectFactor));
